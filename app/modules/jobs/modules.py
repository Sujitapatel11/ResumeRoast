# This file will act as the "source of truth" for what a job listing actually is.
# It will define the columns in the database and the rules for the API.
...
class Joblisting(SQLModel, table=True):
    ...
    def validate_salary(cls, value: str | None) -> str | None:
        """
        Enforce that the salary range is in the format 'min-max'
